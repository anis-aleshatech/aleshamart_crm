...
function permissions(e, t) {
    ...
    var n = "permissions?approve_val=" + o + "&&tablename=" + e + "&&status=" + t;
...
function changestatus(e) {
    for (var t = document.getElementsById("changemtype").value, a = document.getElementsByName("summe_code[]"), l = 0, o = new Array, s = 0; s < a.length; s++) a[s].checked && (o[l] = a[s].value, l++);
    if ("" == o) return alert("Please check one or more!"), !1;
    var n = "changestatus?approve_val=" + o + "&&tablename=" + e + "&&status=" + t;
    window.location.href = n
}

function deletedata(e, t) {
    for (var a = document.getElementsByName("summe_code[]"), l = 0, o = new Array, s = e, n = !1, c = 0; c < a.length; c++) a[c].checked && (o[l] = a[c].value, l++);
    if ("" == o) return swal({
    ...
    swal({
        ...
        e.value ? (n = !0, $.ajax({
            ...
            success: function(e) {
                ...
                e.length;
                for (c in e) $("#tablerow" + e[c]).fadeOut("slow")
            }
        })) : 0 === e.value ? (n = !1, $.ajax({
            type: "GET",
            url: s,
...
$(document).ready(function() {
    ...
    }), $(window).width() <= 480 && jQuery(".submenus").on("click", function() {
...
}), checked = !1, $(document).ready(function() {
    $("#minicarts").on("click", function() {
        $(".shopping-cart").fadeToggle("fast")
    })
});

// custome menu like amazon
