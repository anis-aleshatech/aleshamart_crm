                        ...
                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab" style="margin-top:10px">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="meta_description" type="text" class="form-control" name="meta_description" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="keywords" type="text" class="form-control" name="keywords" autofocus>
                                            {{ $news->keywords }}
                                        </textarea>
