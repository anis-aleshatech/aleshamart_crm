...
font-variant-caps: petite-caps;">You are not allowed to access here</h1>
<h2>Go <a target="_blank" href="{{ route('admin.dashboard') }}">Dashboard</a></h2>
<button class="btn btn-info"> <a target="_blank" href="{{ route('admin.dashboard') }}">Dashboard</a></button>
