      ...
      <div class="row mb-2">
        <div class="col-sm-6" style="margin-bottom: 15px;">
          <div class="page-header" style="border:none">
            <h3 class="page-title">Customer  : {{ $customer_info->fullname }} -- Total Returned Order ({{ $customerOrders->count() }})</h3>
        </div>
        ...
        <div class="col-sm-8 breadcrumb pull-right" style="float:right; text-align:right">
          ...
          <a href="{{ route('admin.customer.returned_orders', [$customer_info->id]) }}" style="color:#fff; margin-right:10px;" class="btn btn-warning btn-sm disabled">Returned Order</a>
