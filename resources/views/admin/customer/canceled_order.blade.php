      ...
      <div class="row mb-2">
        <div class="col-sm-6" style="margin-bottom: 15px;">
          <div class="page-header" style="border:none">
            <h3 class="page-title">Customer : {{ $customer_info->fullname }} -- Total Canceled Order ({{ $customerOrders->count() }})</h3>
        </div>
        ...
        <div class="col-sm-8 breadcrumb pull-right" style="float:right; text-align:right">
          ...
          <a href="{{ route('admin.customer.canceled_orders', [$customer_info->id]) }}" style="color:#fff; margin-right:10px;" class="btn btn-danger btn-sm disabled">Canceled Order</a>
                              ...
                              <div class="col-sm-2">
                                ...
                                <div class="col-sm-2">
                                  <h2>ORDER # {{ $product->ONO }}</h2>
                                    <h3><a href="{{ route('orders.details', [$product->id]) }}">Order Details</a> |
