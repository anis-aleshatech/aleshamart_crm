@extends('admin.include.master')
 @section('title') Order Lists - Aleshamart @endsection
@section('content')
...
<div class="content-wrapper">
      ...
      <div class="row mb-2">
        <div class="col-sm-6" style="margin-bottom: 15px;">
          <div class="page-header" style="border:none">
            <h3 class="page-title">Customer  : {{ $customer_info->fullname }} -- Total Order ({{ $customerOrders->count() }})</h3>
        </div>
        ...
        <div class="col-sm-8 breadcrumb pull-right" style="float:right; text-align:right">
          ...
          {{-- <a href="{{ route('admin.customer.unshipped_orders', [$customer_info->id]) }}" style="color:#fff; margin-right:10px;" class="btn btn-info btn-sm">Unshipped</a> --}}
          ...
          <a href="{{ route('admin.customer.complete_orders', [$customer_info->id]) }}" style="color:#fff; margin-right:10px;" class="btn btn-success btn-sm">Completed Order</a>
          <a href="{{ route('admin.customer.total_orders', [$customer_info->id]) }}" style="color:#fff; margin-right:10px;" class="btn btn-info btn-sm disabled">Total Order</a>
  ...
  <section class="content">
    <!-- Default box -->
    <div class="card">
      {{-- <div class="card-body p-0" style="padding-right:0" id="responsedata"> --}}
                ...
                <div class="orderAreas">
                  <div class="orderHeadline">
                    ...
                    <div class="col-sm-2">
                      ...
                      {{-- <h3><a href="{{ route('aleshamart_orders.orderdetail', [$product->id]) }}">Order Details</a> | --}}
                      <h3><a href="{{ route('admin.orderdetail', [$product->id]) }}">Order Details</a> 
                      {{-- | <a href="{{ route('aleshamart_orders.invoice', [$product->id,'print']) }}" target="_blank">Invoice</a></h3> --}}
                      {{-- <a href="{{ route('admin.invoice', [$product->id,'print']) }}" target="_blank">Invoice</a> --}}
                      </h3>
                    </div>
                  </div>
